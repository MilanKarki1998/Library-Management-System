...
<style>
		...
		<?php include('menu.php'); ?>
			...
			<center id="center"><h2><?php echo strtoupper($row['name']); ?> Activity</h2></center>
				<?php
				$sid=$_SESSION['login'];
				$query ="select students.StudentId,students.name,students.email,students.mobile,students.RegDate,userlog.StdID,userlog.StdIP,userlog.LoginTime from userlog inner join students on students.StudentId=userlog.StdID where userlog.StdID='".$_SESSION['login']."'";
